...
void ABXOpenglWidget::initializeGL()
{
    ...
    unsigned int attributePosition = m_shaderProgram.attributeLocation("aPos");
    ...
    glVertexAttribPointer(attributePosition,3,GL_FLOAT, GL_FALSE, 3*sizeof (float),(void*)0);
